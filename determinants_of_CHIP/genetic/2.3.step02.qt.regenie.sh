...
#########################################################################
#### 1 Dec 2023
## qsub -wd /medpop/esp2/mesbah/projects/ch_progression/aric/gwas/tmpdir  -t 1-22 -R y -l h_vmem=10G -l h_rt=40:00:00 -pe smp 4 -binding linear:4 -N grt.step2.aric_imp_EA /medpop/esp2/mesbah/tools/longitudinal-profiling-of-clonal-hematopoiesis/determinants_of_CH/genetic/2.3.step02.qt.regenie.sh /medpop/esp2/mesbah/datasets/topmed/aric_phs000090_GENEVA/pgen /medpop/esp2/mesbah/projects/ch_progression/aric/gwas/grt_ea.dp20.1Dec2023.tsv "dVAF_by_dT,logdVAF_by_dT" "age_base,age_base_sqr,PC{1:10},is_notHiSeq,is_notMUTECT" "Sex,Center,v2_vs_other" 400 /medpop/esp2/mesbah/projects/ch_progression/aric/gwas/growth_rate EurAm 0.01 /medpop/esp2/mesbah/projects/ch_progression/aric/gwas/growth_rate/NULL_MODEL.EA_strict_pr.plogpred.list 20 4

## qsub -wd /medpop/esp2/mesbah/projects/ch_progression/aric/gwas/tmpdir  -t 1-22 -R y -l h_vmem=10G -l h_rt=40:00:00 -pe smp 4 -binding linear:4 -N grt.step2.aric_imp_EA_strict /medpop/esp2/mesbah/tools/longitudinal-profiling-of-clonal-hematopoiesis/determinants_of_CH/genetic/2.3.step02.qt.regenie.sh /medpop/esp2/mesbah/datasets/topmed/aric_phs000090_GENEVA/pgen /medpop/esp2/mesbah/projects/ch_progression/aric/gwas/grt_ea.dp20allAD5FRRR2.1Dec2023.tsv "dVAF_by_dT,logdVAF_by_dT" "age_base,age_base_sqr,PC{1:10},is_notHiSeq,is_notMUTECT" "Sex,Center,v2_vs_other" 400 /medpop/esp2/mesbah/projects/ch_progression/aric/gwas/growth_rate EurAm_Strict 0.01 /medpop/esp2/mesbah/projects/ch_progression/aric/gwas/growth_rate/NULL_MODEL.EA_strict_pred.list 20 4
